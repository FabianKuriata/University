...
public class Menu {
	static public void main(String[] args) {
		...
		while (true) {
			...
			System.out.println("6. Wyœwietlenie ile jest kart zakrytych i odkrytych");
			System.out.println("7. Usun karte o podanej wartoœci");
			...
			case 7: {
				System.out.println("Podaj wartoœæ karty, któr¹ chcesz usun¹æ");
